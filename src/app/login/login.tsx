        ...
        <div className="w-full max-w-md p-8 space-y-8 bg-white/10 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="relative">
              <Mail className="w-5 h-5 text-accent absolute left-4 top-1/2 -translate-y-1/2 transition-transform duration-300 hover:scale-110 hover:text-accent-light" />
              <input
                type="email"
                value={email}
            ...
            <div className="relative">
              <Lock className="w-5 h-5 text-accent absolute left-4 top-1/2 -translate-y-1/2 transition-transform duration-300 hover:scale-110 hover:text-accent-light" />
              <input
                type="password"
                value={password}
